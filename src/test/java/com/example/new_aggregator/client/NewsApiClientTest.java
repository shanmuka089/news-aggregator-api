...
public class NewsApiClientTest
{
    ...
    @InjectMocks
    private NewsApiClientImpl newsApiClient;
    ...
    void testFetchNewsByPreference() {
        ...
        newsApiClientConfig.setNewsApiSearchPath("/everything");
        ...
        ResponseDto<NewsApiResponse> response = newsApiClient.fetchNewsByPreference(query);
