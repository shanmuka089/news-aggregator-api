...
public class GNewsHeadlinesClientTests
{
    ...
    @InjectMocks
    private GNewsHeadlinesClientImpl gNewsClient;
    ...
    void testFetchNewsByPreference() {
        ...
        gsClientConfig.setGsClientTopHeadlinesPath("/everything");
        ...
        ResponseDto<GNewsResponse> response = gNewsClient.fetchHeadlinesByQuery(query);
